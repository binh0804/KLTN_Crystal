...
def setup():
    ...
    model_file = "/media/binh/D/ComputerVision/data/train_outputs/model_final.pth"
    output_dir =  "/media/binh/D/ComputerVision/data/train_outputs_self"
...
def show_demo_inference_image_from_dataset(dataset_dicts, cfg,sample_size = 1):
  ...
  for d in random.sample(dataset_dicts, sample_size):
    ...
    # img_origin = cv2.resize(dataset_dicts,(512,512))
